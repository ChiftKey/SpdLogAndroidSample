...
public:
    syslog_sink(std::string ident, int syslog_option, int syslog_facility, bool enable_formatting)
        ...
        , syslog_levels_{{/* include.spdlog::level::trace      */ LOG_DEBUG,
              /* include.spdlog::level::debug      */ LOG_DEBUG,
              /* include.spdlog::level::info       */ LOG_INFO,
              /* include.spdlog::level::warn       */ LOG_WARNING,
              /* include.spdlog::level::err        */ LOG_ERR,
              /* include.spdlog::level::critical   */ LOG_CRIT,
              /* include.spdlog::level::off        */ LOG_INFO}}
...
private:
    ...
    //
    // Simply maps include.spdlog's log level to syslog priority level.
    //
